...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="resources/css_js/styleAbousUs2.css" />
  </head>
  <body>
<div class="responsive-container-block bigContainer">
     ...
     >We are happy to see you
      ...
      I am  Java Web Developers having 3.5 years of experience in web development using Java and Spring    
         Framework ,application support. Adept analyzing information system need working with client,business managers
          and technical team for, evaluating end user requirements custom design solution.      </p>
  ...
  <a href="#" title="linkedin">
    ...
    <div class="responsive-container-block rightSide">
      <img class="number1img" src="images/DSC_0413.JPG">
