...
<html lang="en">
  ...
  <body>
    <header class="header">
      <nav class="navbar">
        <h2 class="logo"><a href="index2.jsp">Pushpendra Singh</a></h2>
        ...
        <%--   <li><a href="<%@ include file="ShowUsers.jsp" %>">Products</a></li> --%>
            <li><a href="https://www.flipkart.com/"> <i class='fas fa-cart-arrow-down' style='font-size:30px;color:red'></i></a></li>   
        </ul>
        ...
        <%   String  username=(String)request.getAttribute("username");  %>
              <% if (request !=null  && request.getAttribute("username")!= null) { 
            	  %>
              <i class="fas fa-user"> <p color: red-darkred; > Welcome : <%=username%></p></i>
           
                
                <div class="buttons" onClick=logOut()>
   
                     <a href="index.jsp" class="logout">Logout</a> </div>
            <% } %>
      ...
      <div class="hero">
       ...
       I am  Java Web Developers having 3.5 years of experience in web development using Java and Spring    
        ...
        <div class="buttons">
          ...
          <a href="resources/Images/pushpendraPicture11.jfif" class="learn">Learn More</a>
        </div>
      </div>
      <div class="img">
        <img src="https://media.licdn.com/dms/image/D4D03AQH_duJ2mL7MSw/profile-displayphoto-shrink_800_800/0/1702548705271?e=1724284800&v=beta&t=K8FCj6_n5RZsv2MvJtcnsMqnkrs2kvpPqIPinc3vL4c" alt="hero image" width="300" height="300" />
      </div>
    </section>
     <script>
 function logOut() {
